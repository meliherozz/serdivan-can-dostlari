...
export interface ApiAdoptionApplicationAdoptionApplication
  ...
  attributes: {
    ...
    applicationStatus: Schema.Attribute.Enumeration<
      ['new', 'reviewing', 'contacted', 'approved', 'rejected', 'cancelled']
    > &
      Schema.Attribute.Required &
    ...
    hasOtherPets: Schema.Attribute.Boolean & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    otherPetsDescription: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    ...
    previousPetExperience: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 700;
      }>;
    publishedAt: Schema.Attribute.DateTime;
    reasonForAdoption: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
...
export interface ApiAnimalAnimal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    adoptionStatus: Schema.Attribute.Enumeration<
      ['available', 'reserved', 'adopted', 'unavailable']
    > &
      Schema.Attribute.Required &
    ...
    estimatedBirthDate: Schema.Attribute.Date;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    featuredImage: Schema.Attribute.Media<'images'>;
    gender: Schema.Attribute.Enumeration<['male', 'female', 'unknown']> &
      Schema.Attribute.Required;
    healthRecords: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    microchipped: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 80;
      }>;
    neutered: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    personality: Schema.Attribute.Text &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    species: Schema.Attribute.Enumeration<['dog', 'cat', 'other']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHealthRecordHealthRecord
  ...
  attributes: {
    ...
    recordType: Schema.Attribute.Enumeration<
      ['examination', 'vaccination', 'treatment', 'surgery', 'other']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiShelterInfoShelterInfo extends Struct.SingleTypeSchema {
  collectionName: 'shelter_infos';
  info: {
    displayName: 'Shelter Info';
    pluralName: 'shelter-infos';
    singularName: 'shelter-info';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::shelter-info.shelter-info': ApiShelterInfoShelterInfo;
